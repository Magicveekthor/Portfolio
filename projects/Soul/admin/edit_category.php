...
if(isset($_GET['id'])) {
    $result_category = mysqli_query($mysqli, "SELECT * FROM `soul_category` where id = '$id'");
    $check_category = mysqli_num_rows($result_category);

    if($check_category > 0){
        $row_category = mysqli_fetch_assoc($result_category);
        $product_category = $row_category['product_category'];
        $tmp_file = $row_category['category_image'];
    } else {
...
if(isset($_POST['submit'])){
    ...
    $tmp_file2 = $_FILES['category_image']['name'];
    ...
    if($num_cat > 0) {
        ...
        if($tmp_file2 == ""){
            $update_category = mysqli_query($mysqli, "UPDATE `soul_category` SET product_category = '$product_category', category_image = '$tmp_file' where id = '$id' ");
        } else {
            $update_category = mysqli_query($mysqli, "UPDATE `soul_category` SET product_category = '$product_category' category_image = '$tmp_file2' where id = '$id' ");
        }
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="project-details">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <img style="width:80px; height:80px; object-fit:cover; margin-top:5px;" src="images/category/<?php echo $tmp_file; ?>">
                                    </div>
                                </div>
