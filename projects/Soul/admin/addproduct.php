...
if(isset($_POST['submit'])){
    ...
    $p_color = implode(", ",$_POST['p_size'] ?? []);
    $p_size = implode(", ",$_POST['p_color'] ?? []);
    ...
    $tmp_file = $_FILES['cover_image']['name'];
    move_uploaded_file(($_FILES['cover_image']['tmp_name']), $target_file);


    $insert_products = "INSERT INTO `soul_products` (p_name, p_price, p_keyword, p_categories, p_size, p_color, p_material, p_type, p_descrip, cover_image, status2)
    VALUES('$p_name', '$p_price', '$p_keyword', '$p_categories', '$p_size', '$p_color', '$p_material', '$p_type', '$p_descrip', '$tmp_file', '1 ')";
    $product_query = mysqli_query($mysqli, $insert_products);
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="project-details">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <input type="text" name="p_keyword" placeholder="Enter product keywords">
                                    </div>

                                    <div class="input-box">
                                        <span class="details">Product Category</span>
                                        <select name="p_categories">
                                            <option style="color: #b5b5b5;">Select product category...</option>
                                            <?php 
                                    ...
                                    <div class="input-box">
                                        ...
                                        <select id="multipleSelect" multiple name="p_size[]" placeholder="Select product size(s)" data-search="false" data-silent-initial-value-set="true">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <select id="multipleSelect" multiple name="p_color[]" placeholder="Select product colors(s)" data-search="false" data-silent-initial-value-set="true">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <input type="text" name="p_material" placeholder="Enter material/texture">
                                    </div>
                                    ...
                                    <div class="input-box">
                                        ...
                                        <textarea name="p_descrip" placeholder="Enter Product Description..."></textarea>
                                    </div>
                                </div>
