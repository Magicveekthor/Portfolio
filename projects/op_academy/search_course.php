            ...
            <div class="container">
                ...
                <div class="courses-top">
                    ...
                    <div class="section-title shape-01">
                        ...
                        ?>
                        <h2 class="main-title">Search Records for <span>"<?= $search_box ?>"</span></h2>
                        <?php } ?>
                    </div>
                    <!-- Section Title End -->
                        ...
                        <div class="courses-wrapper">
                            <div class="row">
                                <?php 
                                    if(isset($_POST['search_box']) OR isset($_POST['search_btn'])) {
                                    $search_box = $_POST['search_box'];
                                    $select_courses = $conn->prepare("SELECT * FROM `playlist` WHERE title LIKE '%{$search_box}%' OR search_tag LIKE '%{$search_box}%' AND status = ? ORDER by date DESC");
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="error-content">
                                                                    <h5 class="sub-title">Course Not Found!.</h5>
                                                                    <h2 class="main-title">We are very sorry for error. We cannot find this course <span>"'.$search_box.'".</span></h2>
                                                                    <a href="courses.php" class="btn btn-primary btn-hover-dark">Back To Courses</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="error-wrapper">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="error-content">
                                                        <h5 class="sub-title">Course Not Found!.</h5>
                                                        <h2 class="main-title">We are very sorry for error. We <span> cannot find this</span> course.</h2>
                                                        <a href="courses.php" class="btn btn-primary btn-hover-dark">Back To Courses</a>
                                                    </div>
                                                </div>
                                            </div>
