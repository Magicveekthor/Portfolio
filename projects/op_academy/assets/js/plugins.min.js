...
!(function (e, t) {
  ...
  (function (t, e) {
    ...
    class Z extends M {
      ...
      show() {
        ...
        if (t) {
          ...
          if (
            ((e = i ? w.get(i, "bs.collapse") : null), e && e._isTransitioning)
          )
            return;
        }
    ...
    P.on(
      ...
      function (t) {
        const e = r(this);
        if (
          (["A", "AREA"].includes(this.tagName) && t.preventDefault(), g(this))
        )
          return;
    ...
    class St extends M {
        ...
        this.config.trigger.split(" ").forEach((t) => {
          if ("click" === t)
            ...
            P.on(this._element, e, this.config.selector, (t) => this._enter(t)),
              P.on(this._element, s, this.config.selector, (t) =>
                this._leave(t)
              );
          }
        }),
      ...
      _getConfig(t) {
        ...
        return (
          ...
          t.sanitize &&
            (t.template = Et(t.template, t.allowList, t.sanitizeFn)),
          t
        );
      }
      _getDelegateConfig() {
            ...
            if (i.freeModeMomentum) {
              ...
              if (
                ...
                if (
                  ...
                  g =
                    P < k ? i.speed : P < 2 * k ? 1.5 * i.speed : 2.5 * i.speed;
                }
        ...
        slide: {
          ...
          slideToLoop: function (e, t, a, i) {
            ...
            var s = this,
              r = e;
            return (
              s.params.loop && (r += s.loopedSlides), s.slideTo(r, t, a, i)
            );
          },
      ...
      F = (function () {
        ...
        return (
          ...
          (t.installModule = function (e) {
            ...
            var a =
              e.name || Object.keys(t.prototype.modules).length + "_" + x();
  ...
  $(document).ready(function () {
    ...
    $(vid).attr("src", $("a.link:first").attr("href")),
      ...
      $("a.link").on("click", function (event) {
        event.preventDefault(),
          ...
          vid[0].play(),
          $("a.link:first").hasClass("playing")
            ? $(".prevvid").addClass("disabled")
            : $(".prevvid").removeClass("disabled"),
          $("a.link:last").hasClass("playing")
    ...
    var completeloaded = !1;
    vid.on("canplaythrough", function () {
      completeloaded = !0;
    }),
      vid.on("ended", function () {
        $(".btnPlay").removeClass("paused"), vid[0].pause();
      }),
      vid.on("seeking", function () {
        completeloaded || $(".loading").fadeIn(200);
      }),
      ...
      vid.on("loadedmetadata", function () {
        $(".current").text(timeFormat(0)),
          ...
          vid[0].muted ? updateVolume(0, 0) : updateVolume(0, 0.7);
      });
    var startBuffer = function () {
      var currentBuffer = vid[0].buffered.end(0),
        maxduration = vid[0].duration,
        perc = (100 * currentBuffer) / maxduration;
      $(".bufferBar").css("width", perc + "%"),
        currentBuffer < maxduration && setTimeout(startBuffer, 500);
    };
    vid.on("timeupdate", function () {
      var currentPos = vid[0].currentTime,
        maxduration,
        perc = (100 * currentPos) / vid[0].duration;
    ...
    var playpause = function () {
        vid[0].paused || vid[0].ended
          ? ($(".btnPlay").addClass("paused"), vid[0].play())
          : ($(".btnPlay").removeClass("paused"), vid[0].pause());
      },
      timeDrag = !1;
    $(".progress").on("mousedown", function (e) {
      (timeDrag = !0), updatebar(e.pageX);
    }),
      $(document).on("mouseup", function (e) {
        timeDrag && ((timeDrag = !1), updatebar(e.pageX));
      }),
      $(document).on("mousemove", function (e) {
        timeDrag && updatebar(e.pageX);
      });
    ...
    $(".sound").click(function () {
      (vid[0].muted = !vid[0].muted),
        ...
        vid[0].muted
          ...
          : $(".volumeBar").css("width", 100 * vid[0].volume + "%");
    });
    var volumeDrag = !1;
    $(".volume").on("mousedown", function (e) {
      ...
      $(document).on("mouseup", function (e) {
        volumeDrag && ((volumeDrag = !1), updateVolume(e.pageX));
      }),
      $(document).on("mousemove", function (e) {
        volumeDrag && updateVolume(e.pageX);
      });
    var updateVolume = function (x, vol) {
      ...
      vol
        ? (percentage = 100 * vol)
        : (percentage = (100 * (x - volume.offset().left)) / volume.width());
      percentage > 100 && (percentage = 100),
        percentage < 0 && (percentage = 0),
    ...
    $(".btnspeed").click(function () {
      ...
      $(".btnFS").on("click", function () {
        $.isFunction(vid[0].webkitEnterFullscreen)
          ? vid[0].webkitEnterFullscreen()
          : $.isFunction(vid[0].mozRequestFullScreen)
          ? vid[0].mozRequestFullScreen()
          : alert("Your browsers doesn't support fullscreen");
      }),
      $(".btnLight").click(function () {
        $(this).toggleClass("lighton"),
          $(this).hasClass("lighton")
            ? $(".overlay").remove()
    ...
    var timeFormat = function (seconds) {
      ...
      return (
        m +
        ":" +
        (Math.floor(seconds - 60 * m) < 10
          ? "0" + Math.floor(seconds - 60 * m)
