...
if(isset($_GET['category_id'])) {
    $result_category = mysqli_query($mysqli, "SELECT * FROM `opemzy_categories` where category_id = '$category_id'");
...
if(isset($_POST['submit'])) {
    ...
    if($num_cat > 0) {
        ...
        $update_category = mysqli_query($mysqli, "UPDATE `opemzy_categories` SET category_name = '$category_name' where category_id = '$category_id'");
